...
function myFunction() {
    ...
    if (x.className == "topnav") {
        x.className += "responsive";           /* fonction responsive menu */
    } else {
        x.className = "topnav";
    }
}
...
function checkEmpty() {
    ...
    if (document.getElementById('Famille').value !== "0" && document.getElementById('SousFamille').value !== "0" && document.getElementById('Reference').value !== "" && document.getElementById('Label').value !== "" && document.getElementById('Description').value !== ""  && document.getElementById('PrixTTC').value !== "" && document.getElementById('Image').value !== null) {
