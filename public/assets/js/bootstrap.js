...
function myFunction() {
    ...
    if (x.className === "topnav") {
        x.className += " responsive";           /* fonction pour permettre le menu hamburger */
    } else {
        x.className = "topnav";
    }
}
...
function checkStock() {
    if (document.getElementById('rupture').visibility !== 'hidden') {
        document.getElementById('ajouter').disabled = "disabled";
    }
}
...
function checkEmptyTrier() {
    if (document.getElementById('type').value != "0") {
        ...
        if (document.getElementById('couleur').value != "0") {
            ...
            if (document.getElementById('saison').value != "0") {
                document.getElementById('trier').disabled = "";
            }
            else{
